...
<div  style="margin-left: 12%;padding-top: 12%;;">
 <section class="section"  >
       ...
       <h4 class="card-title mb-6" >{{ __('Ajoute de rapport') }}</h4>
       <div class="col-lg-12" >
           <div class="card">
               ...
               @if (session()->has('success'))
                <div class="alert alert-success">{{ session()->get('success')}}</div>
                 ...
                 <form  class="mb-3" action="{{ route('Rapport.ajout_rapport') }}" method="POST">
                    @csrf
                    @method('POST')
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="action_realise" name="action_realise" value="{{ old('action_realise' ) }}" >
                        ...
                        <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="resultat_obtenu" name="resultat_obtenu" value="{{ old('resultat_obtenu' ) }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="commentaire_supplementaire" name="commentaire_supplementaire" value="{{ old('commentaire_supplementaire' ) }}">
