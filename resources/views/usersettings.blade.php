    ...
    <section class="section">
        ...
        <div class="card-body">
                   <button class="btn btn-primary btn-rounded mb-3" >
                       <a href="{{ route('Auth.inscription')}}" style="color: white;"><span>{{__('Ajouter un(e) utilisateur(e)')}}</span></a>
                   </button>
                <div>
            <div class="card-body custom-card">
                ...
                <div class="form-group row">
                    <label for="created_at"
                        class="col-md-4 col-form-label text-md-right">{{ __('Date de création') }}</label>
                    <div class="col-md-6">
                        <input id="created_at" type="text" class="form-control" value="{{ Auth::user()->created_at }}"
                            disabled>
                    </div>
                </div>
                <div class="form-group row mb-0">
                    <div class="col-md-6 offset-md-4">
                        <button type="button" class="btn btn-primary"
                            onclick="window.location.href='{{ route('useredit') }}'">
                            {{ __('Modifier') }}
                        </button>
                    </div>
                </div>
